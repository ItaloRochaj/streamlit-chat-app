...
PROFILE_NAME = os.environ.get("AWS_PROFILE", "grupo8")
...
st.markdown("""
   ...
   /* Customização do file_uploader para separar texto e botão */
...
if check_password():
    ...
    with main_col2:
        ...
        if st.session_state.renaming:
            ...
            with col2:
                        st.markdown('<div style="display: flex; align-items: center; left: 100%;">', unsafe_allow_html=True)
